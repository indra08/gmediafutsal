...
<head>
    ...
    <title>Invoice | Bukti Registrasi Corporate Futsal Fun Competition</title>
    <style>
        body {
...
<body>
    <div class="wrapper">
        <table width="100%" style="margin-top:-10px;">
            <tr>
                <td width="15%" style="text-align:right">
                    <img width="130px" src="./frontend/images/logo-futsal.png" alt="logo right">
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
        ...
        <div class="top-title-2">
            ...
            Corporate Fun Futsal Competition
        </div>
        <div class="top-title-3">
            <p>Halo! Terima kasih telah melakukan registrasi pendaftaran Corporate Fun Futsal Competition.</p>
            <br>
            <p>
        ...
        <table width="100%" class="table">
            <tbody>
                ...
                <tr>
                    <td class="td-style">Nama Perusahaan</td>
                    <td class="td-style"><?php echo isset($detail->nama_perusahaan) ? $detail->nama_perusahaan:'';?></td>
                </tr>
                <tr>
                    <td class="td-style">Nama Brand</td>
                    <td class="td-style"><?php echo isset($detail->nama_brand) ? $detail->nama_brand:'';?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="td-style bold">Total Pemain Inti</td>
                    <td class="td-style"><?php echo isset($detail->jml_pemain_inti) ? $detail->jml_pemain_inti:'';?> Pemain</td>
                </tr>
                <tr>
                    <td class="td-style bold">Total Pemain Cadangan</td>
                    <td class="td-style"><?php echo isset($detail->jml_pemain_cadangan) ? $detail->jml_pemain_cadangan:'';?> Pemain</td>
                </tr>
            </tbody>
        </table>
